 ...
 */
export declare function getJson<E extends keyof EngineMap, R extends BaseResponse<EngineMap[E]["parameters"]>>(engine: E, parameters: EngineMap[E]["parameters"], callback?: (json: R) => void): Promise<R>;
/**
